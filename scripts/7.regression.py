...
if __name__ == '__main__':
	...
	if lang_dir in ['wolof', 'iban', 'swahili', 'fongbe']: 
		...
		for evaluate_dir in os.listdir(args.input + lang_dir + '/'):
			for output_dir in os.listdir(args.input + lang_dir + '/' + evaluate_dir + '/'):
				...
				print(evaluate_dir)
				train_ave_duration, train_ave_pitch, train_ave_intensity, train_ave_ppl, train_ave_num_word, train_ave_word_type, train_oov, train_duration_total, train_num_word_total, train_word_type_total = gather_train_features('data/' + lang_dir + '/' + evaluate_dir + '/train' + index + '/text', lexicon, all_features)
				...
				number = output_dir[6 : ]
				gold_file = 'data/' + lang_dir + '/' + evaluate_dir + '/dev' + number + '/text'
